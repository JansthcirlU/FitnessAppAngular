...
import { WorkoutPlanDataService } from '../workout-plan/workout-plan-data.service';
...
@Injectable()
export class PlanExercisesDataService implements InMemoryDbService {

  constructor(
    private planService: WorkoutPlanDataService,
